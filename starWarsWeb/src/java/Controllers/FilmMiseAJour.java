    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(!request.getParameter("modifier").isEmpty() && "modifier".equals(request.getParameter("modifier"))){
            try{
                ...
                int filmNumEpisode = film.getNumEpisode();
                ...
                try (PrintWriter out = response.getWriter()) {
                    out.println("<!DOCTYPE html>"
                            ...
                            + "<div class=\"row\">"
                            + "<div class=\"col-12\">"
                            + "<h1>Mettre à jour un film <small style=\"font-size:16px;\"><a href=\"/starWarsWeb/\">[accueil]</a></small></h1>"
                            + "<hr>"
                            ...
                            + "<input type=\"texte\" class=\"form-control\" name=\"FilmNumEpisode\" placeholder=\"(int)\" value=\""+filmNumEpisode+"\"/>"
                            + "<br>"
